...
public class SMSSenderServiceImpl implements SMSSenderService {
    ...
    public String sendSMS(String from, String to, String message) {
        ...
        try {
            String url = String.format("https://api.budgetsms.net/testsms/?Credit=1&username=petria&userid=18436&handle=c11bc789efcd53818aedd7020c2dc5c6&msg=%s&from=%s&to=%s", URLEncoder.encode(message, "UTF-8"), from, to);
            log.debug("URL: {}", url);
